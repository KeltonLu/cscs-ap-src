...
namespace CIMSBatch.Public
{
    class  GlobalString
    {
        ...
        public static class WarningType
        {
            ...
            //200908CR 匯入替換前版面小計檔與替換前版面廠商異動檔 add by 楊昆 2009/09/04 start
            ...
            //200908CR 匯入替換前版面小計檔與替換前版面廠商異動檔 add by 楊昆 2009/09/04 end
            //201005CR 增加物理寄卡單、DM警訊 add by Ian Huang 2010/06/11 start
            public const string BatchWarningMateriel002And003 = "61";
