...
public class Warning
{
    ...
    public static void SetWarning(string strType, object[] arg)
    {
        ...
        switch (strType)
        {
            ...
            // 200908CR§Èµ≤Æ…°A(¥¿¥´´e™©≠±)ºt∞”Æw¶s≤ß∞ Æ÷πÔ¶≥ª~ add by ∑®©¯ 2009/09/04 start
            case GlobalString.WarningType.BatchCompareFactoryReplace: bw.BatchCompareFactoryReplace(strType, arg[0].ToString()); break;
            // 200908CR§Èµ≤Æ…°A(¥¿¥´´e™©≠±)ºt∞”Æw¶s≤ß∞ Æ÷πÔ¶≥ª~ add by ∑®©¯ 2009/09/04 end
            //201005CR ºW•[™´≤z±H•d≥Ê°BDMƒµ∞T add by Ian Huang 2010/06/11 start
            ...
            //201005CR ºW•[™´≤z±H•d≥Ê°BDMƒµ∞T add by Ian Huang 2010/06/11 end
            default: break;
        }
